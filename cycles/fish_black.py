...
for i in range(40,num_files):
    ...
    numSamples = 1 # recommend > 200 for paper images (UI: Scene > Render > Sampling > Render)
    exposure = 1.5 # exposure of the entire image (UI: Scene > Render > Film > Exposure)
    blenderInit(imgRes_x, imgRes_y, numSamples, exposure)

    # construct input and output paths
    meshPath = '../meshes/fish/fishInput'
    outputPath = './results/fish/fishInput'
    idx = i + 1
